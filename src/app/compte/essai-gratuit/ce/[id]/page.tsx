...
export default function FreePracticeSessionPage() {
  ...
  const onClose = async () => {
    try {
      ...
      router.push("/compte/essai-gratuit?type=ce");
    } catch (error: any) {
  ...
  if (isNotFreemium) {
    return <FreemiumRestricted categorySlug="ce" />;
  }
        ...
        <div className="container mx-auto p-6">
          <Card>
            <div className="p-6 flex flex-col items-center justify-center py-12">
              ...
              <Button onClick={() => router.push("/compte/essai-gratuit")}>
            ...
            <CardContent className="p-6">
              ...
              <div className="space-y-6">
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center mt-8">
                  ...
                  <Button
                    onClick={() => router.push("/compte/essai-gratuit?type=ce")}
                    variant="outline"
                    size="lg"
                  >
                    Retour aux exercices
        ...
        <div className="container mx-auto p-6">
          <Card>
            <CardContent className="p-6 flex flex-col items-center justify-center py-12">
              ...
              <Button onClick={() => router.push("/compte/essai-gratuit?type=ce")}>
                Retour aux exercices
              </Button>
            </CardContent>
          </Card>
