...
export default function PracticeSessionPage() {
  ...
  const onClose = async () => {
    if (!session) {
      router.push("/compte/pratique/ce");
      return;
    }
  ...
  const onRefresh = () => {
    ...
    if (session) {
      practiceSessionService.cancelSession(session._id).catch(console.error);
    }
    setSession(null);
        ...
        <div className="container mx-auto p-6">
          <Card>
            <div className="p-6 flex flex-col items-center justify-center py-12">
              ...
              <Button onClick={() => router.push("/compte/pratique/ce")}>
  ...
  if (sessionResult) {
    ...
    return (
      <PracticeLayout>
        <Header title={practice.title} onClose={onClose} onRefresh={onRefresh} />
        <div className="container mx-auto p-6 max-w-4xl">
          <Card className={`border-2 ${getResultColor(sessionResult.grade)}`}>
            ...
            <div className="p-6 space-y-6">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center mt-8">
                ...
                <Button
                  onClick={() => router.push("/compte/pratique/ce")}
                  variant="outline"
                  size="lg"
                >
                  Retour aux exercices
