...
const stats = [
  { id: 1, name: "Utilisateurs actifs", value: "6,700+" },
  { id: 2, name: "Tests complétés", value: "27K+" },
  { id: 3, name: "Taux de réussite", value: "96%" },
    ...
    <div className="bg-black py-14 sm:py-20 md:py-20 relative overflow-hidden">
      <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="mx-auto max-w-2xl lg:max-w-none">
          ...
          <dl className="mt-4 sm:mt-6 grid grid-cols-2 gap-2 lg:gap-2 lg:grid-cols-4">
            {stats.map((stat) => (
              <Card key={stat.id} className="items-center justify-center bg-tertiary">
