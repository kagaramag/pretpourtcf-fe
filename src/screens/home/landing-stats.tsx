...
export default function LandingStats() {
  return (
    <div className="bg-white py-10 sm:py-20 md:py-10">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-2xl lg:max-w-none">
          <div className="text-center">
            <h2 className="text-3xl font-semibold tracking-tighter text-gray-900 sm:text-4xl">
          ...
          <dl className="mt-4 sm:mt-6 grid grid-cols-2 gap-8 lg:grid-cols-4">
            {stats.map((stat) => (
              <div
                key={stat.id}
                className="flex flex-col items-center justify-center bg-gradient-to-br from-primary/5 to-primary/10 p-6 sm:p-8 rounded-2xl"
              >
                <dt className="text-sm font-medium text-gray-600 text-center">
                  {stat.name}
                </dt>
                <h3 className="mt-2 text-3xl sm:text-4xl font-bold tracking-wide text-primary">
                  {stat.value}
                </h3>
              </div>
            ))}
